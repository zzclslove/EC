...
<div class="usBox clearfix">
  <div class="usBox_1 f_l">
   ...
   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
	  ...
	  <?php if ($this->_var['_CFG'] [ 'ihuyi_sms_mobile_log' ] == '1'): ?>
	  <tr>
            <td width="30%" align="right"><?php echo $this->_var['lang']['label_username']; ?>/手机号</td>
            <td width="70%"><input name="username" type="text" size="25" class="inputBg" /></td>
          </tr>
	  <?php else: ?>
	  <tr>
	  ...
	  <td></td>
	  <td>
		<?php if ($this->_var['_CFG'] [ 'ihuyi_sms_mobile_pwd' ] == '1'): ?>
		<a href="user.php?act=mpassword_name" class="f3">手机短信找回密码</a><br />
		<?php endif; ?>
		<a href="user.php?act=qpassword_name" class="f3"><?php echo $this->_var['lang']['get_password_by_question']; ?></a><br />
...
?>
	...
	<?php elseif ($this->_var['field']['reg_field_name'] == '手机'): ?>
		<?php if ($this->_var['_CFG'] [ 'ihuyi_sms_mobile_reg' ] == '1'): ?>
			...
			<tr>
			  ...
			  <td>
			  <input name="extend_field<?php echo $this->_var['field']['id']; ?>" id="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" size="25" class="inputBg" maxlength="12" /><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
			  </td>
			</tr>
			<tr>
			  <td align="right">短信验证码
			  <td>
			  <input name="sms_verifycode" id="sms_verifycode" type="text" size="25" class="inputBg" maxlength="6" /><span style="color:#FF0000"> <input type="button" id="zphone" value="<?php if ($this->_var['smsyy'] == 0): ?>获取语音验证码<?php else: ?>获取手机验证码<?php endif; ?>"  onclick="getverifycode1('extend_field<?php echo $this->_var['field']['id']; ?>', '<?php echo $this->_var['field']['reg_field_name']; ?>');"></span>
			  </td>
			</tr>
	...
	<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
	  ...
	  <a href="user.php?act=mpassword_name" class="f3">手机短信找回密码</a><br />
	  <?php endif; ?>
	  <a href="user.php?act=qpassword_name" class="f3"><?php echo $this->_var['lang']['get_password_by_question']; ?></a>
...
<div class="usBox">
  <div class="usBox_2 clearfix">
    <form action="user.php" method="post" name="getPasswordByMobile" onsubmit="return submitPwdMobileInfo();">
        ...
        <table width="70%" border="0" align="center">
          <tr>
            <td colspan="2" align="center"><strong><?php echo $this->_var['lang']['username_and_mobile']; ?></strong></td>
          </tr>
          <tr>
            <td width="29%" align="right"><?php echo $this->_var['lang']['username']; ?></td>
